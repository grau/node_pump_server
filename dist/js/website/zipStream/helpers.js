 ...
 * @returns Human friendly timestamp string
 */
export function formatDateShort(timestamp = Date.now()) {
 ...
 */
export function formatDateFilename(timestamp = Date.now()) {
...
export function formatTimeDuration(time) {
    const div = (divisor) => Math.floor(time / divisor * 10) / 10;
 ...
 */
export function roundBy(number, digits = 2) {
 ...
 */
export function fetchString(url) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield fetch(url);
        return result.text();
    });
 ...
 */
export function startDataDownload(data, filename, mimeType = 'application/octet-stream') {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            reader.addEventListener('load', (event) => {
                var _a, _b;
                if (((_a = event.target) === null || _a === void 0 ? void 0 : _a.result) !== null && ((_b = event.target) === null || _b === void 0 ? void 0 : _b.result) !== undefined) {
 ...
 */
export function fileDownload(data, filename, mime = 'application/octet-stream') {
    var _a;
    const blob = new Blob([data], { type: mime });
    const blobUrl = ((_a = window.URL) === null || _a === void 0 ? void 0 : _a.createObjectURL) !== undefined
 ...
 */
export function getPngFromSvg(svgElem) {
    return __awaiter(this, void 0, void 0, function* () {
